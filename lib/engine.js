      ...
      <div class="body">
        ...
        <div>
          <div style="display:flex;gap:8px">
            <button class="btn" id="polish" style="flex:1" title="Reescribe el paso en lenguaje técnico, al instante y sin IA">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"><path d="M12 3l1.9 5.1L19 10l-5.1 1.9L12 17l-1.9-5.1L5 10l5.1-1.9z"/></svg>
              Redactar técnico
            </button>
          </div>
...
$("#polish").addEventListener("click", () => {
  ...
  istatus("Redactado. Revisa y ajusta lo que quieras.");
});
