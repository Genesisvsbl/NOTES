...
let bgImg = null, sampleFn = null, sampleImages = false, editTarget = null, avisoColor = false;
...
function showSelUI(){
  ...
  if (!avisoColor){
    avisoColor = true;
    toast("Con algo seleccionado, toca un color para cambiárselo.", 3800);
  }
...
async function exportPDF(){
  ...
  const pt0 = HOJA_PT[S.pages[0].hoja || "a4-v"];
