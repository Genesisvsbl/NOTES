...
async function editItem(o){
  ...
  if (o.t === "stp"){
    const t = await pedir("Título del paso "+(o.n||""), o.title || "");
    if (t == null) return;
    const d = await pedir("Descripción del paso "+(o.n||""), o.text || "");
    if (d == null) return;
    pushUndo(); o.title = t.trim(); o.text = d.trim();
    redraw(); markDirty(); renderSteps(); return;
  }
